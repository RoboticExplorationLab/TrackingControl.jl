...
# Taken from model.jl in RobotDynamics, written by Brian
...
n,m = size(model)
"""
abstract type AbstractModel end   #Change That
...
"""
abstract type RigidBody{R<:Rotations.Rotation} <: LieGroupModel end            # changed the stuff here, should not need this
